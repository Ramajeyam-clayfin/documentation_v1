            ...
            <View style={{flex:1}}>
                <ScrollView >
                  ...
                  <Text style={{fontSize:18, margin:15}}>This introduction lets you get started immediately 
                    ...
                    <Text style={{fontSize:18, margin:15, marginBottom:100}}>The above is a Snack Player. It’s a handy tool created by Expo to embed and run React Native projects and share how they render in platforms like Android and iOS.
