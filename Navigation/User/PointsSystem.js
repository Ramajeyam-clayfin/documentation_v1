    ...
    <View style={styles.container1}>
      ...
      <View style={{flex:1}}>
        <View style={styles.container2}>
          ...
          <View style={[styles.card1,{marginBottom:0, flex:0.5}]}>
            <Text style={[styles.h1, {fontWeight:"bold", color:"#61dafb", fontSize:30, marginBottom:30}]}>Guides :</Text>
          ...
          <View style={[styles.card1,{flex:1,}]}> 
            ...
            <Text style={[styles.h1,{marginBottom:10}]}>Total Components : 24</Text>
            ...
            <Text style={[styles.h1,{marginBottom:10}]}>Total : 26 Points</Text>
